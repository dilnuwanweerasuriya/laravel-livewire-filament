                        ...
                        <tbody>
                            @forelse ($cart_items as $item)
                                <tr wire:key='{{ $item['product_id'] }}'>
                                    ...
                                    <td class="py-4">{{ Number::currency($item['unit_amount'], 'LKR') }}</td>
                                    <td class="py-4">
                                        <div class="flex items-center">
                                    ...
                                    <td class="py-4">{{ Number::currency($item['total_amount'], 'LKR') }}</td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-4xl font-semibold text-slate-500">No items available items in the cart!</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-semibold">{{ Number::currency($grand_total, 'LKR') }}</span>
                    </div>
                    @if ($cart_items)
